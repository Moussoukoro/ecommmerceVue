          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form @submit.prevent="handleRegister">
                ...
                <ArgonInput v-model="password" id="password" type="password" placeholder="Password" aria-label="Password" />
                ...
                <div class="text-center">
                  <ArgonButton fullWidth color="dark" variant="gradient" class="my-4 mb-2">
                    Sign up
                  </ArgonButton>
                </div>
